...
export const candidates=[
    ...
    profilePic: profileImg,
        ...
        phone:"+2203283624",
        skills:["Java","Spring Boot","REST APIs","PostgreSQL","Docker","CI/CD","Microservices","TDD"],
        education:[
            {
                id:1,
    ...
    profilePic: profileImg,
        ...
        phone:"+2202456789",
        skills:["React","JavaScript","CSS3","HTML5","Tailwind CSS","Accessibility","Redux","Figma"],
        education:[
            {
                id:1,
                institution:"University of The Gambia",
    ...
    profilePic: profileImg,
        ...
        phone:"+2203311223",
        skills:["Python","SQL","Pandas","Excel","Data Visualization","Power BI","Statistics","ETL"],
        education:[
            {
                id:1,
                institution:"University of The Gambia",
    ...
    profilePic: profileImg,
        ...
        phone:"+2207755044",
        skills:["UX Research","Wireframing","Prototyping","Figma","User Testing","Design Systems","Accessibility","Interaction Design"],
        education:[
            {
                id:1,
    ...
    profilePic: profileImg,
        ...
        phone:"+2206611445",
        skills:["Docker","Kubernetes","Terraform","AWS","CI/CD","Linux","Monitoring","GitHub Actions"],
        education:[
    ...
    profilePic: profileImg,
        ...
        phone:"+2207722990",
        skills:["Threat Monitoring","SIEM","Incident Response","Vulnerability Assessment","Network Security","Linux","Risk Analysis","OWASP"],
        education:[
